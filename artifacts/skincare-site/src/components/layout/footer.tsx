      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <h2 className="font-serif text-3xl font-bold mb-4 text-brand-light">Nolique</h2>
            <p className="text-primary-foreground/70 text-sm mb-6 max-w-xs">
              Prescription rosacea care formulated by dermatologists, delivered to your door.
            </p>
            <div className="space-y-2 text-sm text-primary-foreground/80">
              <p>support@joinnolique.com</p>
              <p>1-800-555-NOLIQUE</p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-primary-foreground/50">
          <p>© {new Date().getFullYear()} Nolique Health Inc. All rights reserved.</p>
        ...
        <div className="mt-12 text-[10px] leading-relaxed text-primary-foreground/40 max-w-5xl">
          ...
          <p>
            Nolique partners with independent medical groups and pharmacies to provide telehealth services. Pharmacy services provided by Nolique Pharmacy Network. Check our Pharmacy Providers page for a complete list of licensed pharmacies.
          </p>
        </div>
      </div>
    </footer>
